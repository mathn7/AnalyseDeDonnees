...
function Donnees(Affichage::Bool)
	...
	MAT.matwrite("src/TP2/mat/Resultat-Donnees.mat", Dict(
		"xy_donnees_bruitees" => xy_donnees_bruitees,
		"theta_points_ellipse" => collect(theta_points_ellipse),
		"F_1" => F_1,
		"F_2" => F_2,
		"a" => a
	))
