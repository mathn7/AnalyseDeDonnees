...
% x est donne par ses coordonnées sur la grille(r,v)
% w_i est caractérisée par mu_i et Sigma_i
% le dénominateur de classe peut être
%   - calcule (et retourne comme résultat) si denominateur_classe_i = -1
%   - ou fourni
...
% calcul de vraisemblances pour des vecteurs r et v associes aux données
